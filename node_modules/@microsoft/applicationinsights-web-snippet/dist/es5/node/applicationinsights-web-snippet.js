/*!
 * Application Insights JavaScript SDK - Web Snippet, 1.2.3
...
(function (global, factory) {
    ...
    function getSdkLoaderScript(config) {
        ...
        var sourceMap = _getSourceMap(originSnippet);
        var sourcemapComment = sourceMap[0];
        var cleanedSnippet = sourceMap[1];
        var configString = JSON.stringify(snippetConfig);
        var result = "!(function (cfg){" + cleanedSnippet + "})(\n" + configString + "\n);";
